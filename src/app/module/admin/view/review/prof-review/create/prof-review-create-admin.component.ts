...
@Component({
  selector: 'app-prof-review-create-admin',
  templateUrl: './prof-review-create-admin.component.html'
})
export class ProfReviewCreateAdminComponent extends AbstractCreateController<ProfReviewDto, ProfReviewCriteria, ProfReviewService>  implements OnInit {
