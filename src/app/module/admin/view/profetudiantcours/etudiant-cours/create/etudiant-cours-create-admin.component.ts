...
@Component({
  selector: 'app-etudiant-cours-create-admin',
  templateUrl: './etudiant-cours-create-admin.component.html'
})
export class EtudiantCoursCreateAdminComponent extends AbstractCreateController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService>  implements OnInit {
    ...
    constructor( private etudiantCoursService: EtudiantCoursService , private profService: ProfService, private coursService: CoursService, private etudiantService: EtudiantService) {
