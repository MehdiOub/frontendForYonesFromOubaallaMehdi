...
export class EtudiantCoursViewAdminComponent extends AbstractViewController<EtudiantCoursDto, EtudiantCoursCriteria, EtudiantCoursService> implements OnInit {
