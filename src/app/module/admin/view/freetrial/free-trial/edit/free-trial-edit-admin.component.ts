...
export class FreeTrialEditAdminComponent extends AbstractEditController<FreeTrialDto, FreeTrialCriteria, FreeTrialService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateFreeTrial = this.freeTrialService.format(this.item.dateFreeTrial);
        this.item.emailTeacherSendingDate = this.freeTrialService.format(this.item.emailTeacherSendingDate);
        this.item.whatsTeacherSendingDate = this.freeTrialService.format(this.item.whatsTeacherSendingDate);
        this.item.dateFreeTrialPremierRappel = this.freeTrialService.format(this.item.dateFreeTrialPremierRappel);
        this.item.dateFreeTrialPremierDeuxiemeRappel = this.freeTrialService.format(this.item.dateFreeTrialPremierDeuxiemeRappel);
    }
