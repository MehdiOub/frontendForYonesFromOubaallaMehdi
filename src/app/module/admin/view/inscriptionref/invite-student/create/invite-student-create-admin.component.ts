...
export class InviteStudentCreateAdminComponent extends AbstractCreateController<InviteStudentDto, InviteStudentCriteria, InviteStudentService>  implements OnInit {
