...
@Component({
  selector: 'app-etudiant-review-create-admin',
  templateUrl: './etudiant-review-create-admin.component.html'
})
export class EtudiantReviewCreateAdminComponent extends AbstractCreateController<EtudiantReviewDto, EtudiantReviewCriteria, EtudiantReviewService>  implements OnInit {
    ...
    constructor( private etudiantReviewService: EtudiantReviewService , private profService: ProfService, private coursService: CoursService, private etudiantService: EtudiantService) {
